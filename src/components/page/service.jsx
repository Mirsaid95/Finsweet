        ...
        <div className="max-w-[1024px] mx-auto p-2 pt-10 pb-10">
          <div className="flex flex-col gap-4 md:flex-row md:gap-8 lg:items-center">
            ...
            <div className="flex flex-col gap-4 text-center md:text-start md:flex-1">
              ...
              <h1 className="text-[#232536] text-[20px] leading-8 font-medium tracking-wider md:text-[32px] md:font-semibold lg:text-[46px] lg:tracking-wider lg:leading-10">
                Bring your ideas to reality with certified team of developers,
                working with latest technologies{" "}
              </h1>
              <p className="text-[#232536] text-[12px] tracking-wide md:text-[16px] lg:leading-6 lg:text-[18px]">
                Through True Rich Attended does no end it his mother since real
                had half every him case in packages enquire we up ecstatic
                unsatiable saw his giving Remain expense you position concluded.
                Through True Rich Attended does no end it his mother since real
        ...
        <div className="max-w-[1024px] mx-auto p-2 pt-10 pb-10">
          <div className="flex flex-col gap-4 md:flex-row md:gap-8 text-center md:text-start md:items-center">
            <div className="flex flex-col gap-4 flex-1">
              <p className="text-[#232536] text-[12px] font-semibold uppercase md:normal-case">
                AWS/Azure
              </p>
              <h1 className="text-[#232536] text-[20px] font-semibold tracking-wide md:text-[32px] leading-8 lg:text-[46px] lg:leading-none">
        ...
        <div className="max-w-[1024px] mx-auto p-2 pt-10 pb-10">
          <div className="flex flex-col gap-4 md:flex-row md:gap-8 text-center md:items-center">
            ...
            <div className="flex flex-col gap-4 text-center md:text-start md:flex-1">
              ...
              <h1 className="text-[#232536] text-[20px] font-semibold tracking-wide md:text-[32px] lg:text-[46px]">
